...
void loop()
{
    ...
    if (status == MI_OK)
    {
        ...
        uchar* id = serNum;
        if( id[0]==0x83 && id[1]==0xF1 && id[2]==0xD4 && id[3]==0xE5 ) {
            Serial.println("Hello Blue thingy!");
        } 
        else if(id[0]==0x4A && id[1]==0x43 && id[2]==0xE5 && id[3]==0x7B) {
            Serial.println("My FedUni ID!");
        }
        else if(id[0]==0x88 && id[1]==0x04 && id[2]==0x65 && id[3]==0x21) {
            Serial.println("Helloooooo Myki!");
        }
        else{
